    ...
    player = {
        ...
        indicators = {
            ...
            extraManaBar = {
                ...
                width = 175,
                height = 5,
                color = {type = "mana_color", alpha = 1, rgb = AF.GetColorTable("uf_power"), gradient = "disabled"},
                lossColor = {type = "mana_color_dark", alpha = 1, rgb = AF.GetColorTable("uf"), gradient = "disabled"},
                bgColor = AF.GetColorTable("background"),
                borderColor = AF.GetColorTable("border"),
                texture = "AF",
                smoothing = false,
            ...
            classPowerBar = {
                ...
                height = 6,
                spacing = 1,
                color = {type = "power_color", alpha = 1, rgb = AF.GetColorTable("uf_power"), gradient = "disabled"},
                lossColor = {type = "power_color_dark", alpha = 1, rgb = AF.GetColorTable("uf"), gradient = "disabled"},
                bgColor = AF.GetColorTable("background"),
                borderColor = AF.GetColorTable("border"),
                texture = "AF Plain",
                cooldownText = {
    ...
    pet = {
        ...
        indicators = {
            healthBar = {
                ...
                width = 75,
                height = 22,
                color = {type = "custom_color", alpha = 0.6, rgb = AF.GetColorTable("uf"), gradient = "disabled"},
                lossColor = {type = "custom_color", alpha = 1, rgb = AF.GetColorTable("uf_loss"), gradient = "disabled"},
                bgColor = AF.GetColorTable("background", 0),
                borderColor = AF.GetColorTable("border"),
                texture = "AF",
